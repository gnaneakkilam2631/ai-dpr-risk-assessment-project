  ...
  () => {
    ...
    const handleSendMessage =
      async (
        ...
        try {
          /*
           * Send the existing conversation
           * to the Copilot service.
           */
          const response =
            await copilotService.askQuestion(
              query.trim(),
              messages
            );
        ...
        setMessages([
          {
            ...
            content:
              `Chat history cleared. Grounded in **${activeProject.name}**. What would you like to investigate?`,
    ...
    const handleExportTranscript =
      () => {
        ...
        anchor.download =
          `${activeProject.code}_Copilot_Transcript.txt`;
      ...
      <div className="flex flex-col h-[calc(100vh-140px)] max-w-5xl mx-auto space-y-4">
            ...
            <div className="flex gap-3 justify-start">
              ...
              <div className="rounded-2xl bg-white p-3.5 shadow-xs border border-slate-200 dark:bg-[#0f172a] dark:border-slate-800 flex items-center gap-1.5">
                ...
                <span className="text-xs text-slate-500 font-mono ml-2">
                  Consulting DPR Knowledge Graph...
                </span>
        ...
        >
          ...
          <input
            ...
            placeholder="Ask anything about this DPR..."
